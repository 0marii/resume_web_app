...
<body>
    <div>
        ...
        <button class="nav-button" onclick="location.href='ViewApplication.jsp';">View Application</button>
        <button class="nav-button" onclick="location.href='login.jsp';">log out</button>
        <button class="nav-button" onclick="location.href='interview.jsp';">Show users</button>
    </div>
    <main>
